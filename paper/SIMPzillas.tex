...
%Consistent with inflaton stuff?
 
\end{abstract}

%We calculate the expected SIMP signal rate using a nuclear-stopping formalism, assuming straight-line trajectories and accounting for the form factor suppression of the stopping cross section and the full 3-dimensional velocity distribution.
